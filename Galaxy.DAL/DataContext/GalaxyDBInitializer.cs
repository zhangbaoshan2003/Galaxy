    ...
    public class GalaxyDBInitializer : System.Data.Entity.DropCreateDatabaseAlways<GalaxyDB>
    {
        protected override void Seed(GalaxyDB context)
        {
            ...
            {   
                new Product()
                {
                    Name = "元达信资本-履泰2期证券投资基金",AdministratorID = 1,ConsultentID = 1,ProductTypeID = 1,CustodyBank = "中信建投证券",Broker = "中信建投证券",
                    IssueDate = DateTime.Today.AddYears(-1),LifeTime = 20,InitialInvestment = 1000000000,ProportionOfConsultant = 0.15,
                    MinimumBuy = 1000000,StepBuy = 100000,ClosureTerm = "1年,第一个开放日之后，产品转为管理型",OpenTerm = "封闭期后每季度X日开放，可申购赎回。（遇节假日顺延）",
                    SubscriptionFee = 0,RedemptionFee = 0,ManagementFee = 0.003,
                    ...
                    WayToReceiveBonus = "无",ThresholdOfWarning = 0.9,
                    WarningDesc = "0.90（产品净值触及预警线或在预警线以下，投顾指定投资者可追加增强资金，使产品净值回到预警线以上，若投顾方选择不追加增强资金或追加增强资金后产品净值仍低于0.95，管理人会将风险资产仓位控制在50%以下）",
                    TresholdOfStopLoss = 0.87,
                    StopLossDesc = "0.87（在本资管计划存续期内任何一个工作日（T日）收盘后，经管理人估算的基金单位净值不高于止损线的，投顾方有权选择于t+1日10：00前追加增强资金，使产品净值高于止损线，否则管理人强制平仓止损）",
                    SecurityTypeToInvest = "主要投资于沪、深交易所A股股票、沪港通、基金、债券、新股申购（网下新股申购除外）、银行存款等。",
                    ConstrainsOfInvestment ="1. 本基金投资于一家上市公司所发行的股票，不得超过该上市公司总股本的4.99%，同时不得超过该上市公司流通股本的10%；2. 购买单一非创业板公司股票不超过基金总资产的40％；购买单一创业板公司股票不超过基金总资产的20％，所有投于创业板的股票不超过基金总资产的30%。3. 不得投资于ST、*ST、S类股票；4. 不得投资于权证。5. 不得购买管理人自身发行的股票以及与管理人存在关联关系的上市公司股票。" ,
                    StrategyTypeID = 1
                },
            };
            products.ForEach(p =>
